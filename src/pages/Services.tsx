          ...
          <div className="grid md:grid-cols-2 gap-8">
            {SERVICE_PILLARS.map((svc, idx) => {
              ...
              return (
                <div
                  key={svc.id}
                  className="group relative bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 flex flex-col border border-gray-100"
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={item.stat} className="text-center p-8 rounded-2xl border border-gray-100 hover:shadow-lg transition-all duration-300">
                <div className="text-5xl font-black mb-2" style={{ color: GOLD }}>{item.stat}</div>
